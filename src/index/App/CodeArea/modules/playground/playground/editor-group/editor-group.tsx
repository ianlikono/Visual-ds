...
import { SourceFile } from '../../../../shared/modules/interpreter'
import { Editor, Highlight } from '../../../shared/modules/playground/editor'
import { Editor as CodeMirrorEditor } from 'codemirror'
import { getFileExtension } from '../../../shared/url'
import { useThemeColors } from '../../../shared/hooks'
import _classes from './editor-group/editor-group.module.css'
    ...
    >
      ...
      <div className={_classes.editorContainer}>
        {files.map((file) => {
          ...
          const lint: Highlight = { lines: [2], className: "codeError"}
          return (
            <Editor
              handles={{
                root: (editor) => {
